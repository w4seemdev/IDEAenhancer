...
function build(seed: string): IdeaCard[] {
  ...
  return [
    ...
    },
    {
      ...
      twist: 'Turn the single tool into the default platform others build on top of: an ecosystem, not a feature.',
    ...
    },
    {
      ...
      biggestRisk: 'Contrarian can mean "wrong," and you need a real reason the consensus is leaving value on the table.',
    },
    {
